...
let mockData = [
    {
        id: 1,
        rank: 1,
        report: "สรุปผลสำเร็จของการดำเนินงานในภาพรวม"
    },
    {
        id: 2,
        rank: 2,
        report: "สรุปผลสำเร็จของการดำเนินงาน (แยกตามสำนัก/กอง)"
    },
    {
        id: 3,
        rank: 3,
        report: "สรุปผลสำเร็จของการดำเนินงาน (แยกตามยุทธศาสตร์)"
    },
    {
        id: 4,
        rank: 4,
        report: "สรุปผลสำเร็จของการดำเนินงาน (แยกตามแผนงาน)"
    },
    {
        id: 5,
        rank: 5,
        report: "สรุปผลสำเร็จของการดำเนินงาน (โครงการทั้งหมด)"
    },
    {
        id: 6,
        rank: 5.1,
        report: "โครงการทั่วไป"
    },
    {
        id: 7,
        rank: 5.2,
        report: "โครงการก่อสร้าง"
    },

]


const ReportShowingOperational = () => {
        ...
        const objRenderData = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    align: "right",
                    component: (
                        <div className='text-left h-full w-full flex justify-end'>
                    ...
                    <motion.div
                        ...
                        <section>
                            <Typography className='text-primary' variant='h4'>
                                {"รายงานการแสดงผลสัมฤทธิ์การดำเนินงาน"}
                            </Typography>
                        </section>
...
export default ReportShowingOperational
